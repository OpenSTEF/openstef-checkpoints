...
# The small size is published under the autogluon org, not amazon.
CHRONOS2_SMALL = Chronos2Model(slug="chronos-2-small", source_model_id="autogluon/chronos-2-small")
